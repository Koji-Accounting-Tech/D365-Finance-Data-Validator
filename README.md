...
- ・Developed a User Risk Scoring model based on sign-in results, OS compliance, and access timing
- ・Developed a Dynamic Risk Scoring engine that flags users based on multiple security and compliance factors
