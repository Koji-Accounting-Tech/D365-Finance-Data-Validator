...
- ・Developed a Time-series Trend Analysis tool for monitoring Microsoft Entra sign-in patterns
- ・Analyzed the correlation between time of day and security block reasons using Heatmaps
